...
function start_contrail() {
    ...
    run_process analytics-nodemgr "contrail-nodemgr --nodetype=contrail-analytics"
    run_process control-nodemgr "contrail-nodemgr --nodetype=contrail-control"
    run_process config-nodemgr "contrail-nodemgr --nodetype=contrail-config"
    run_process vrouter-nodemgr "contrail-nodemgr --nodetype=contrail-vrouter"
